...
The analysis demonstrates an overall improvement on the group-wise and mean absolute errors compared with other unfolding methods, the best case showing a mean, group-wise error of 18.5\%.
\end{abstract}
