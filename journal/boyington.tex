...
\author{John Boyington% <-this % stops a space
...
Are they not the best figures you've ever seen.
MAXED works better without the shielded responses, Gravel works better once you include them.
Gravel also is less afraid to depart from the default spectrum in the 1/E region, so that's coolio.
